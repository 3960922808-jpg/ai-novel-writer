...
- 小说技能包：内置小说立项、人物设计、情节架构、场景写作、稿件修订、长篇写作和短篇写作；多技能 ZIP 或文件夹可勾选后批量导入。
...
- `TrmWrite-Setup-2.1.8.exe`：安装版。
- `TrmWrite-2.1.8-x64.zip`：免安装压缩版，解压后运行。
- `TrmWrite-Portable-2.1.8-x64.exe`：单文件便携版，无需安装和解压。

推送形如 `v2.1.8` 的标签后，GitHub 工作流会自动构建并把三种文件上传到对应版本页面，并附带 SHA-256 校验文件。
