...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'characters', name: 'characters', component: () => import('@/views/CharacterLibrary.vue'), meta: { title: '角色库' } },
      ...
      { path: 'sweep', name: 'sweep', component: () => import('@/views/SweepRanking.vue'), meta: { title: '扫榜拆解' } },
